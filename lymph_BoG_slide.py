...
'''
Building histograms, training BoW model. 
'''
def train():
    print("TRAIN entered")
...
def test(tr_histograms, kmeans, codebook, labels, tr_order_to_label):
    ...
    #VisualAI cluser Validation:
    #PATH_LEN = 49
    #PATH = "/n/fs/visualai-scr/emmanuel/lymph-130/validation/*.svs"

    #VisualAI cluser Testing:
    #PATH_LEN = 44
...
# tr_histograms, hist, testSize, tr_order_to_label, labels, test_order_to_label = test(histograms, kmeans, codebook, labels, tr_order_to_label)
# print("K: ")
# print(K)
# print("Resolution: ")
# print(RESOLUTION)
# classify(tr_histograms, hist, testSize, tr_order_to_label, labels, test_order_to_label)